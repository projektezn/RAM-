...
document.getElementById("setBreakpoint").addEventListener("click", () => {
  ...
  let przycisk = document.getElementById("setBreakpoint");

  if (breakpointMode) {
    alert("Kliknij wiersz w tabeli programu, aby ustawić lub usunąć breakpoint.");
    enableBreakpointMode();
      przycisk.style.backgroundColor = "#353f4d";
      przycisk.style.border = "3px dashed #fa786a"
  } else {
    disableBreakpointMode();
      przycisk.style.backgroundColor = "#64748b";
